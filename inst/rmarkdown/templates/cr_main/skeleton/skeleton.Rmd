...
> Let's start with a short introduction. Explain briefly what this document is going to talk about. Maybe add a [useful link](https://github.com/holtzy/epuRate) relative to this project.
...
library(crthemes)      # Install with devtools: install_github("holtzy/crthemes", force=TRUE)
```
